...
/**
 * Writes to the HTTP Authorization header field without percent encoding the signature
 *
 */
public class MKMAuthorizationHeaderSigningStrategy implements SigningStrategy {
    ...
    public String writeSignature(String signature, HttpRequest request,
        ...
        oauthParams.put(OAuth.OAUTH_SIGNATURE, signature, false);
